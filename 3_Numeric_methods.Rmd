...
$$p = \frac {\text{number of S's in the sample}}{n}$$

Where S is the label used for the response designated as success.  The population proportion of successes is denoted by $\pi$.
