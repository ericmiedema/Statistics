...
* **Start one discussion topic** on Moodle on why you are interested in statistics
* **Reply to two** discussion topics that you find interesting.
...
Cluster: Example all studends in a few selected classes
</div>
...
4. Replication: Ensuring that there is an adequate number of observations in each experimental condition and the study can be dublicated.
